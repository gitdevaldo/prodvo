...
const TIMELINE = [
  ...
  { date: "Q3 2025", event: "Closed beta expansion", detail: "Expanded beta to 500+ users, iterated on feedback, refined the planning engine and agent reliability." },
  { date: "Q1 2026", event: "Public launch", detail: "Publicly launched with thousands of active users building real production software." },
