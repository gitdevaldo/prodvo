...
export default function FaqPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Yes. We run a responsible disclosure program for security researchers. If you discover a vulnerability, please report it to security@prodvo.com. We respond within 24 hours and offer rewards for valid findings.`,
    },
    {
      category: "security",
